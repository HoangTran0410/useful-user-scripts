...
WebAssembly.instantiate = function (buffer, imports) {
  ...
  find(
    array,
    [OP_END, OP_I32_LOAD8_U, -1, -1, OP_I32_CONST, 1, OP_I32_SUB, OP_BR_TABLE],
    function (i, end) {
      console.log("here!!");
  ...
  find(
    array,
    [OP_F32_CONST, ...Float32ToArray(2), OP_SET_LOCAL, -1],
    function (start, end) {
...
<div class="dialog">${
  shouldShowAd
	...
	<div class="btn" style="background: #c73420;" onclick="window.open('https://www.instagram.com/zertalious/', '_blank')">Instagram</div>
	<div class="btn" style="background: #32a430;" onclick="window.open('https://twitter.com/Zertalious', '_blank')">Twitter</div>
...
if (shouldShowAd) {
  ...
  window.location.href =
    "https://zertalious.xyz?redirect_to=random&ref=" +
